...
def generate_instances(nb_of_instances, min_n, max_n, lp_dir, solveInstance, er_prob):
...
if __name__ == "__main__":
    ...
    generate_instances(n, min_n, max_n, lp_dir, True, er_prob)
    """
    data_partition = "test"
    min_n = 60
    max_n = 70
    lp_dir = os.path.join(os.path.dirname(__file__), exp_dir + data_partition + '/')
    generate_instances(50, min_n, max_n, lp_dir, False, er_prob)
    data_partition = "transfer"
    #initial features, but maybe mistake
    min_n = 80
    max_n = 100
    #new one
    min_n = 70
